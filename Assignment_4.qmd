...
\- (Breil, 2010) Breil FA, Weber SN, Koller S, Hoppeler H, Vogt M. Block training periodization in alpine skiing: effects of 11-day HIT on VO2max and performance. Eur J Appl Physiol. 2010 Aug;109(6):1077-86. doi: 10.1007/s00421-010-1455-1. Epub 2010 Apr 4. PMID: 20364385. (<https://pubmed.ncbi.nlm.nih.gov/20364385/)>

\- (Gomez, 2020) GC3mez MartC-n JP, Clemente-SuC!rez VJ, Ramos-Campo DJ. Hematological and Running Performance Modification of Trained Athletes after Reverse vs. Block Training Periodization. Int J Environ Res Public Health. 2020 Jul 4;17(13):4825. doi: 10.3390/ijerph17134825. PMID: 32635515; PMCID: PMC7369883. (https://pubmed.ncbi.nlm.nih.gov/32635515/)

\- (Hebisz, 2021) Hebisz P, Hebisz R, Drelak M. Comparison of Aerobic Capacity Changes as a Result of a Polarized or Block Training Program among Trained Mountain Bike Cyclists. Int J Environ Res Public Health. 2021 Aug 23;18(16):8865. doi: 10.3390/ijerph18168865. PMID: 34444612; PMCID: PMC8393863. (<https://pubmed.ncbi.nlm.nih.gov/34444612/)>

-(a) (Rønnestad, 2012a) Rønnestad BR, Hansen J, Ellefsen S. Block periodization of high-intensity aerobic intervals provides superior training effects in trained cyclists. Scand J Med Sci Sports. 2014 Feb;24(1):34-42. doi: 10.1111/j.1600-0838.2012.01485.x. Epub 2012 May 31. PMID: 22646668. (<https://pubmed.ncbi.nlm.nih.gov/22646668/)>

-(b) (Rønnestad, 2012b) Rønnestad BR, Ellefsen S, Nygaard H, Zacharoff EE, Vikmoen O, Hansen J, HallC)n J. Effects of 12 weeks of block periodization on performance and performance indices in well-trained cyclists. Scand J Med Sci Sports. 2014 Apr;24(2):327-35. doi: 10.1111/sms.12016. Epub 2012 Nov 8. PMID: 23134196. (<https://pubmed.ncbi.nlm.nih.gov/23134196/)>
...
I denne raporten skal eg ta for meg ein analyse av 5 originale forskningsstudier som undersøker effekten av blokk-periodisering med høgintensitetstrening på Vo2-max til trente idrettsutøverar. Studiene er forskjellige i den grunn at de har ulik antall forsøkspersoner samt at deltakerne kommer fra ulik idrettsbakgrunn. Tre av studiene inneheld godt trente sykkelister (Rønnestad, 2012a. Hebisz, 2021. Rønnestad 2012b) , ein av studiene inneheld trente løpere (Gomez, 2020) og den siste inneheld alpinister (Breil, 2010). Studiene har også ulik lengde på blokkperiodiseringen og ulik treningsplan

Til tross for ulikheitene i forskningsprosjektene, prøver forskarane i hovudsak å finne  ein treningsmetode som kan være meir effektiv for å øke prestasjonen i sin idrett. Meir spesifikk ønsker desse to studiene (Rønnestad, 2012a. Rønnestad 2012b) å finne ut om en blokkperiodisering av høgintensitetstrening vil øke Vo2-max og terskelwatt mer en tradisjonell trening dersom volumet er likt, hos trente sykkelister. Denne studien (Gomez, 2020) prøver å finne ut av kva som vill øke vo2-max og løpeprestasjonen mest av å trene blokkpreiodisering og reversed training periodisering. I denne studien (Heibisz, 2020) ønsker dei å finne ut kva som øker den aerobe kapasiteten og vo2-max mest av blokkperiodisering og plarized treningsprogram hos mountainbike sykkelister. Den siste studien (Breil, 2010) ser etter kor stor auking i Vo2-max og prestasjon alpinister kan oppnå av ein blokkperiodisering av høgintesitetstrening.

Desse problemstillingane er blannet av å bli lagt fram som ein spørsmål og som ei hypotese. Begge studiene (Rønnestad, 2012a. Rønnestad, 2012b) har både spørsmål og hypotese. Der spørsmålet er om blokkperiodisering vil gi bedre adaptasjoner en tradisjonell trening, medan hypotesen er at blokkperiodisering vill føre til bedre adaptasjoner samanligna med tradisjonell trening sjølv om treingsvolumet er likt. Ei alternativ hypotese til dette vill da være at tradisjonell trening vil gi betre adaptasjoner enn blokkperiodisering, eller at dei vill gi samme treningsadaptasjoner. På den andre sida har me (Breil, 2010. Gomez, 2020. Heibisz, 2020) som har lagt fram sin problemstilling som spørsmål. 
...
Denne type studiedesign er gullstandard innen forskningsdesign, spesielt dersom me ønsker å undersøke årsakssammenheng. Grunnene til at dette studiedesignet er så pålitelige er både grunnet den tilfeldige fordelinge, som minimerer sjangsen for at ulike grupper har systematiske forskjeller før studien starter. Forskerene har i tillegg ein god kontroll på at treningen blir gjennomført og at det blir gjort riktig, de kan da eliminere bort deltakere som for eksempel ikkje har fått gjennomført nokon av treningene. Fleire av desse studiene har også en kontrollgruppe som ikkje får behandlingen. Dette gjer at me kan samenligne den reele effekten kvar av gruppene har fått. Dette gjer randomisert kontrollert studie til en verdifull metode for å undersøke effekten av ulike intervensjoner. 
Vanligvis i en slik type studie vill det være gunnstig å blinde både deltakere og forsker. Dette vill føre til at de ikke blir påvirket av kva gruppe dei er i, og eliminerer mulig plasebo-effekt. I desse studiene eg analyserer er dette vanskeleg. Deltakerne er selvfølgelig klar over kva treningsmetode dei bruker. Likevell går det for eksempel an å blinde testlederen. Dersom ein gjer dette, kan det føre til at testlederen for eksempel ikkje heier ekstra på de forsøkspersonene som har gjennomført blokkperiodisering, for å oppnå det resultatet en ønsker. Som gjort i dei studiene eg analyserer, har deltakerne ikkje fått vite resultat under pre og post testingen. Dette hindrer at deltakerne blir pårverka av deira prestasjon undervegs i testen. 

Dersom me ser på korleis dei utvalgte studiene blei utførte, ser me at dei har ganske likt oppsett. Enkelt forklart har dei valgt å gjennomføre ein pre test før forsøkspersonene satt i gang med treningsintervensjonen deira. Etter å ha gjennomført treningsintervensjonen, gjennomførte dei ein post test rundt ei veke etter for å undersøke den eventluelle framgangen til dei ulike gruppene. Ulikheitene mellom studiene var variasjon i lengden på treningintervensjonen. Her vill ein lengre treningintervensjon sansynlig vis føre til ein større skilnad mellom deu ulike gruppene, og det vill også være lettere å oppdage ei forskjell mellom pre- og post testene og dermed øke signifikansen til resultatene. Her speler både treningsopplegget og det fysiske nivået til forsøkspersonene også ein rolle, sidan godt trente personer krever meir stimuli for samme prestasjonsauking som utrente. 
