...
cat("Utvalg 1 (n=8):\n")
cat("  Gjennomsnitt:", mean_samp1, "\n")
cat("  Standardavvik:", sd_samp1, "\n")
cat("  Standardfeil:", se_samp1, "\n")
cat("  t-verdi:", t_value_samp1, "\n\n")

cat("Utvalg 2 (n=40):\n")
cat("  Gjennomsnitt:", mean_samp2, "\n")
cat("  Standardavvik:", sd_samp2, "\n")
cat("  Standardfeil:", se_samp2, "\n")
cat("  t-verdi:", t_value_samp2, "\n")
```

1. Forklaring av estimering, standardfeil, t-verdi og p-verdi fra regresjonsmodellene m1 og m2:
...
2. #for å finne p-verdiene for m1 og m2 gjer e følgande
